...
Making a new character now includes a default multiplier for all constraints, meaning you can more easily create effects like this!
...
Under a very particular, but useful circumstance, the solver would struggle to obey.
...
In this release you no longer have to make that sacrifice, and constraints will behave as you'd expect!
