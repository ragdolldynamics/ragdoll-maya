...
- [**IMPROVED** Manipulator and Multiple Solvers](#multi-manipulator) Choose which solver to manipulate, with this new UI
...
When there are two or more manipulator in the scene, Ragdoll would pick one at random. This was not very helpful, so instead it will now kindly ask you to choose one.



<br>

#### Selection Highlight on Selected Retarget
...
Giving markers a density of 0 would make it infinitely light, or infinitely heavy depending on your perspective. Such things does not exist in the real world and cannot be simulated. Ragdoll will now protect you against such occurrences!
