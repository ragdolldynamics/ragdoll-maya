...
- [**ADDED** Animated Initial State](#initial-state) Dynamic Controls now also control the initial state of rigids, find out what this means!
- [**ADDED** Worldspace Dynamic Control](#world-space-dynamic-control) Control worldspace position and orientation with this newly added feature
...
Guide forces in dynamic controls are all *local*.

![ragdolllocal](https://user-images.githubusercontent.com/2152766/105635342-2d006400-5e5a-11eb-9415-3fe140471ab9.gif)

And since many versions ago, you've been able to append these "Guide" controls, that are in worldspace (per default).
