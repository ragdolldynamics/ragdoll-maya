...
"Ragdoll Complete" is the cost-effective flavour of Ragdoll, suitable for freelancers and indie studios. It lacks studio-conveniences such as a Python API, export to JSON and is less performant than "Ragdoll Unlimited", being unable to operate in parallel across multiple cores.
...
Can you spot it? That's right! It's rendered with DirectX!

Ragdoll didn't like this, and was an exclusively OpenGL kind of dude. This all changes today, with newly added support for DirectX on Windows.
