...
Over time, I'll add "auto fixed" and tutorial-like material to help actually *solve* some of these warnings and errors. The goal as an animator is to never get *any* messages, which takes practice and patience. :)
