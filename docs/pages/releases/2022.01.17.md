...
On Febuary 1st, prices will reach their intended full price, leaving Early Bird behind. Until then, you can use the **voucher code above** to make one last purchase before the deadline.
...
- Or the need controls other than your rig to [actually *animate the thing*](/releases/2021.05.10/)
...
This is the version freelancers *can afford*.
