...
Ragdoll really likes OpenGL and didn't take too kindly to the Windows-exclusive DirectX rendering mode.

But now all has changed, and it's happy to render using either OpenGL or DirectX. No known visual or performance difference, go crazy.
