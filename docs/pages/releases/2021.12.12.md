...
Rigids remain accessible via the new `Legacy` submenu in the Ragdoll menu, scenes using Rigids remain functional and will continue to run until end of February 2022.
